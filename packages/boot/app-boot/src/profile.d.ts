 ...
 */
export declare function readProfileBundleState(manifest: ProfileManifest): ProfileBundleState
/**
 ...
 */
export declare function setProfileBundleEnabled(manifest: ProfileManifest, packageName: string, enabled: boolean): ProfileManifest
/**
 ...
 */
export declare function reconcileProfileBundles(
